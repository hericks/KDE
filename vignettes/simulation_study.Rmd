...
```
In this simulation study we essentially compare the three bandwidth estimation functions *cross_validation*, *goldenshluger_lepski* and *pco_method* from the package *KDE*. (kurz zum comparison mehr ? kurze übersicht?)
