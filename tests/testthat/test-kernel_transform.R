...
test_that("bandwidth is working",{
  ...
  expect_true(triangular_stretched(0) < triangular$fun(0))
  expect_true(triangular_compressed(0) > triangular$fun(0))
})
...
test_that("sample is shifting the kernel",{
  ...
  expect_equal(triangular$fun(0), triangular_shifted(2))
  expect_true(triangular$fun(2) < triangular_shifted(2))
  expect_true(triangular$fun(0) > triangular_shifted(0))
})
